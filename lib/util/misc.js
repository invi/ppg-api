...
const addonDataURI = prefixURI + 'ppg-api/';

function uri(path) {
  return addonDataURI + "data/" + (path || '');
}
...
exports.data_load = function(path) {
  return readURI(uri(path));
}

exports.lib_url = function(path) {
    return addonDataURI + "lib/" + (path || '');
}

exports.data_url = function(path) {
    return addonDataURI + "data" + (path || '');
}
